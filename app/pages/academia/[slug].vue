  ...
  <main class="w-full">
    ...
    >
      <div class="max-w-4xl mx-auto px-6 text-black">
        ...
        <p class="mt-4 text-lg max-w-xl opacity-90">
          Domina la fotografía dental desde la comodidad de tu hogar u oficina.
        </p>
    ...
    <section class="py-20 bg-white">
      ...
      >
        ...
        <div>
          ...
          <p class="mt-2 text-gray-600">
            Ya seas principiante o fotógrafo con experiencia, este curso es para
            ti.
          </p>
        </div>
        ...
        <div>
          ...
          <p class="mt-2 text-gray-600">
            Aprende a tu propio ritmo con acceso ilimitado a los videos.
          </p>
        </div>
      </div>
    </section>
      ...
      >
        <div class="text-center md:text-left">
          <h2 class="text-3xl md:text-4xl font-light leading-snug">
            Domina el arte de la Fotografía Odontológica a tu propio ritmo, en
            tu propio tiempo.
          </h2>
          <p class="mt-4 text-gray-600">
            Llevando los talleres del Dr. Jaime Ramos directamente a tu hogar y
            oficina.
          </p>
        </div>
    ...
    <section class="py-20 bg-gray-50">
      ...
      <p class="text-center text-gray-600 mb-12">
        Mira la introducción de cada capítulo para tener una muestra de lo que
        viene.
      </p>
...
// Get cursos-virtuales group
const cursosVirtualesSection = academiaSection?.items?.find(
  (item) => item.label === "cursos virtuales",
);

const cursoItem = cursosVirtualesSection?.items?.find((item) =>
...
<style>
/* Ensure text looks elegant like Thinkific */
h1,
h2,
h3 {
