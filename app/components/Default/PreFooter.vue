<template>
    <section class="py-16 text-white bg-gray-900">
        <div
            class="grid grid-cols-1 gap-12 px-4 mx-auto max-w-6xl md:grid-cols-3"
        >
            <!-- VIDEO COLUMN -->
            ...
            <div class="md:col-span-2">
                <div class="p-8 bg-gray-800 rounded-lg shadow-lg">
                    <p class="mb-2 text-lg">
                        Es el curso que estás buscando
                        <span class="font-semibold text-blue-400">tenemos</span>
                        también
                    ...
                    <p class="mb-6 text-sm text-gray-300">
                        No te preocupes. Inscríbete en la lista de espera de
                        DentLit Academy y, en cuanto se abra un cupo o un nuevo
                        curso, te lo haremos saber.
                    </p>
                    ...
                    <form class="mx-auto space-y-5 max-w-lg">
                        ...
                        <div class="w-full">
                            ...
                            >
                                ...
                                <option
                                    value="Cursos de Rehabilitación Adhesiva y Preparación Dental"
                                >
                                    Cursos de Rehabilitación Adhesiva y
                                    Preparación Dental
                                </option>
                        ...
                        <!-- Checkbox -->
                        <label
                            class="flex items-start space-x-2 text-xs text-gray-500"
                        >
                            <input
                                type="checkbox"
                                required
                            ...
                            />
                            <span>
                                Al enviar tu información, aceptas recibir
                                correos electrónicos y mensajes de texto con
                                información de marketing de nuestra parte.
...
<script setup>
// No script needed unless you want real form submission logic.
</script>
